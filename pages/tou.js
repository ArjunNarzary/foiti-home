  ...
  return (
    <div className="px-1">
      <Head>
        ...
        />
        <meta property="og:title" content="Foiti - Terms of Use" />
        <meta
          property="og:description"
          content="Foiti's Terms of Use contains all the rules governing your access of all Foiti services."
        />
        <meta property="og:url" content="https://foiti.com/terms-of-use" />
      ...
      <main>
        <div className="py-12 px-6">
          ...
          <p>
            ...
            country to use Foiti. If you are under 18, you may only use the
            Services with the prior consent of your parent or legal guardian.
            Please be sure your parent or legal guardian has reviewed and
            discussed these Terms with you before you start using the Services.
          </p>
          <br></br>
          <p>
          ...
          <br></br>
          <p>You must not be a convicted sex offender.</p>
          <h1 className="font-bold mt-10 mb-4">Rights We Grant You</h1>
          <p>
          ...
          <br></br>
          <p>
            For all content you submit to the Services, you grant Foiti and our
            affiliates a worldwide, royalty-free, sublicensable, and
            transferable license to host, store, cache, use, display, reproduce,
            modify, adapt, edit, publish, analyse, transmit, and distribute that
            content. This license is for the purpose of operating, developing,
            providing, promoting, and improving the Services and researching and
            developing new ones. This license includes a right for us to make
            your content available to, and pass these rights along to, service
            providers with whom we have contractual relationships related to the
          ...
          <p>
            ...
            have and make available in our Service, we retain all rights to our
            content (but not yours).
          </p>
          <br></br>
          <p>
            We always love to hear from our users. But if you provide feedback
            or suggestions, just know that we can use them without compensating
            you, and without any restriction or obligation to you. You agree
            that we will own all rights in any materials or items we develop
          ...
          <p>
            Additional terms and conditions listed on the Foiti Terms & Policies
            page or that are otherwise made available to you may apply to
            specific Services. If you use those Services, then those additional
            terms become part of these Terms. If any of the applicable
            additional terms conflict with these Terms, the additional terms
            will prevail while you are using the Services to which they apply.
          </p>
          ...
          <p>
            ...
            policies (including our Community Guidelines) or we are permitted or
          ...
          <ul>
            <li>
              ...
              licence and they have not deleted it (in which case this licence
          ...
          <br></br>
          <p>
            Foiti honours copyright laws and takes reasonable steps to
          ...
          <ul>
            <li>
              use branding, logos, icons, user interface elements, designs,
              photographs, or any other materials Foiti makes available via the
            ...
            <li>
              ...
              sell, lease, syndicate, broadcast, display, make available, make
              derivatives of, or otherwise use the Services or the content on
            ...
            <li>
              create more than one account for yourself, create another account
              if we have already disabled your account, attempt to access the
              Services through unauthorized third-party applications, solicit
              login credentials from other users, or buy, sell, rent, or lease
              access to your account, a username, or a friend link;
            </li>
            <li>
              reverse engineer, duplicate, decompile, disassemble, or decode the
              Services (including any underlying idea or algorithm), or
              otherwise extract the source code of the software of the Service;
            </li>
            <li>
            ...
            <li>
              use the Services in a way that could interfere with, disrupt,
          ...
          <ul>
            <li>
              ...
              account. This step may be necessary to protect the safety of our
              users, and others, to investigate, remedy, and enforce potential
              Terms violations, and to detect and resolve any fraud or security
              concerns.
            </li>
            <br></br>
            <li>
          ...
          <p>
            ...
            SMS messages from Foiti related to the Services, including about
            promotions, your account, and your relationship with Foiti.
          </p>
          <br></br>
          <p>
            If you change or deactivate the mobile phone number that you used to
            create an account, you must update your account information through
            Settings within 72 hours to prevent us from sending messages
            intended for you to someone else.
          </p>
          <h1 className="font-bold mt-10 mb-4"> Third-Party Services</h1>
          <p>
          ...
          <br></br>
          <p>
            While we hope you remain a lifelong Foiti user, you can terminate
            these Terms at any time and for any reason by deleting your Foiti
            account.
          </p>
          <br></br>
          <p>
            We may terminate or temporarily suspend your access to the Services
            if you fail to comply with these Terms, our Community Guidelines or
            the law, for any reason outside of our control, or for any reason,
          ...
          <br></br>
          <p>
            Regardless of who terminates these Terms, both you and Foiti
            continue to be bound by the Terms.
          </p>
          <h1 className="font-bold mt-10 mb-4"> Indemnity</h1>
          <p>
            ...
            available, or approved by Foiti; (b) your content, including
            infringement claims related to your content; (c) your breach of
            these Terms or any applicable law or regulation; or (d) your
            negligence or wilful misconduct.
          </p>
          <h1 className="font-bold mt-10 mb-4"> Disclaimers</h1>
          <p>
          ...
          <h1 className="font-bold mt-10 mb-4"> Limitation of Liability</h1>
          <p>
            ...
            CONSEQUENTIAL, PUNITIVE, OR MULTIPLE DAMAGES, OR ANY LOSS OF PROFITS
            ...
            THROUGH THE SERVICES; OR (C) UNAUTHORIZED ACCESS, USE, OR ALTERATION
            OF YOUR CONTENT, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF
            SUCH DAMAGES. IN NO EVENT WILL OUR AGGREGATE LIABILITY FOR ALL
            CLAIMS RELATING TO THE SERVICES EXCEED THE GREATER OF ₹1000 OR THE
            AMOUNT YOU PAID US IN THE 12 MONTHS PRECEDING THE DATE OF THE
          ...
          <p>
            These Terms are governed by the laws of India. You agree that any
            action, suit or other legal proceeding, you have against us that
            arises out of or relates to these Terms shall be subject to the
            Jurisdiction of the courts of Guwahati, India
          </p>
          <h1 className="font-bold mt-10 mb-4"> Final Terms</h1>
          <p>
            These Terms, including the additional terms referenced in Section 4,
            make up the entire agreement between you and Foiti, and supersede
            ...
            these Terms, it will not be considered a waiver. We reserve the
            right to transfer our rights under these Terms and provide the
            Services using another entity, provided that entity upholds these
            Terms. You may not transfer any of your rights or obligations under
            these Terms without our consent. We reserve all rights not expressly
            granted to you.
          </p>
          <br></br>
          <br></br>
